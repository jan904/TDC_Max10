...
//dcfifo_mixed_widths DEVICE_FAMILY="MAX 10" LPM_NUMWORDS=512 LPM_SHOWAHEAD="OFF" LPM_WIDTH=8 LPM_WIDTH_R=8 LPM_WIDTHU=9 LPM_WIDTHU_R=9 OVERFLOW_CHECKING="ON" RDSYNC_DELAYPIPE=4 READ_ACLR_SYNCH="OFF" UNDERFLOW_CHECKING="ON" USE_EAB="ON" WRITE_ACLR_SYNCH="ON" WRSYNC_DELAYPIPE=4 aclr data q rdclk rdempty rdreq wrclk wrfull wrreq INTENDED_DEVICE_FAMILY="MAX 10" ALTERA_INTERNAL_OPTIONS=AUTO_SHIFT_REGISTER_RECOGNITION=OFF
//VERSION_BEGIN 23.1 cbx_a_gray2bin 2024:05:14:17:53:42:SC cbx_a_graycounter 2024:05:14:17:53:42:SC cbx_altdpram 2024:05:14:17:53:42:SC cbx_altera_counter 2024:05:14:17:53:42:SC cbx_altera_gray_counter 2024:05:14:17:53:42:SC cbx_altera_syncram 2024:05:14:17:53:42:SC cbx_altera_syncram_nd_impl 2024:05:14:17:53:42:SC cbx_altsyncram 2024:05:14:17:53:42:SC cbx_cycloneii 2024:05:14:17:53:42:SC cbx_dcfifo 2024:05:14:17:53:42:SC cbx_fifo_common 2024:05:14:17:53:42:SC cbx_lpm_add_sub 2024:05:14:17:53:42:SC cbx_lpm_compare 2024:05:14:17:53:42:SC cbx_lpm_counter 2024:05:14:17:53:42:SC cbx_lpm_decode 2024:05:14:17:53:42:SC cbx_lpm_mux 2024:05:14:17:53:42:SC cbx_mgl 2024:05:14:18:00:13:SC cbx_nadder 2024:05:14:17:53:42:SC cbx_scfifo 2024:05:14:17:53:42:SC cbx_stratix 2024:05:14:17:53:42:SC cbx_stratixii 2024:05:14:17:53:42:SC cbx_stratixiii 2024:05:14:17:53:42:SC cbx_stratixv 2024:05:14:17:53:42:SC cbx_util_mgl 2024:05:14:17:53:42:SC  VERSION_END
// synthesis VERILOG_INPUT_VERSION VERILOG_2001
// altera message_off 10463



//a_graycounter DEVICE_FAMILY="MAX 10" PVALUE=1 WIDTH=10 aclr clock cnt_en q
//VERSION_BEGIN 23.1 cbx_a_gray2bin 2024:05:14:17:53:42:SC cbx_a_graycounter 2024:05:14:17:53:42:SC cbx_cycloneii 2024:05:14:17:53:42:SC cbx_mgl 2024:05:14:18:00:13:SC cbx_stratix 2024:05:14:17:53:42:SC cbx_stratixii 2024:05:14:17:53:42:SC  VERSION_END
...
module  dual_fifo_a_graycounter
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		sclr = 1'b0,
		updown = 1'b1;
endmodule //dual_fifo_a_graycounter


//a_graycounter DEVICE_FAMILY="MAX 10" PVALUE=1 WIDTH=10 aclr clock cnt_en q ALTERA_INTERNAL_OPTIONS=suppress_da_rule_internal=S102
//VERSION_BEGIN 23.1 cbx_a_gray2bin 2024:05:14:17:53:42:SC cbx_a_graycounter 2024:05:14:17:53:42:SC cbx_cycloneii 2024:05:14:17:53:42:SC cbx_mgl 2024:05:14:18:00:13:SC cbx_stratix 2024:05:14:17:53:42:SC cbx_stratixii 2024:05:14:17:53:42:SC  VERSION_END
...
module  dual_fifo_a_graycounter1
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		sclr = 1'b0,
		updown = 1'b1;
endmodule //dual_fifo_a_graycounter1
...
endmodule //dual_fifo_altsyncram
...
module  dual_fifo_alt_synch_pipe
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	assign
		q = wire_dffpipe12_q;
endmodule //dual_fifo_alt_synch_pipe
...
`endif
	...
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		...
		else if  (ena == 1'b1)   dffe16a <= (dffe15a & (~ sclr));
	assign
		ena = 1'b1,
		prn = 1'b1,
		q = dffe16a,
		sclr = 1'b0;
endmodule //dual_fifo_dffpipe1
...
`endif
	...
	// synopsys translate_on
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		if (prn == 1'b0) dffe18a <= {10{1'b1}};
		else if (clrn == 1'b0) dffe18a <= 10'b0;
		else if  (ena == 1'b1)   dffe18a <= (d & {10{(~ sclr)}});
	// synopsys translate_off
	initial
		dffe19a = 0;
	// synopsys translate_on
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		...
		else if  (ena == 1'b1)   dffe19a <= (dffe18a & {10{(~ sclr)}});
	assign
		ena = 1'b1,
		prn = 1'b1,
		q = dffe19a,
		sclr = 1'b0;
endmodule //dual_fifo_dffpipe12
...
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"X_ON_VIOLATION_OPTION=OFF;SYNCHRONIZER_IDENTIFICATION=FORCED_IF_ASYNCHRONOUS;PRESERVE_REGISTER=ON;DONT_MERGE_REGISTER=ON;ADV_NETLIST_OPT_ALLOWED=NEVER_ALLOW"} *)
module  dual_fifo_alt_synch_pipe1
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	wire  [9:0]   wire_dffpipe17_q;

	dual_fifo_dffpipe12   dffpipe17
	( 
	.clock(clock),
	.clrn(clrn),
	.d(d),
	...
	assign
		q = wire_dffpipe17_q;
endmodule //dual_fifo_alt_synch_pipe1


//lpm_compare DEVICE_FAMILY="MAX 10" LPM_WIDTH=10 aeb dataa datab
//VERSION_BEGIN 23.1 cbx_cycloneii 2024:05:14:17:53:42:SC cbx_lpm_add_sub 2024:05:14:17:53:42:SC cbx_lpm_compare 2024:05:14:17:53:42:SC cbx_mgl 2024:05:14:18:00:13:SC cbx_nadder 2024:05:14:17:53:42:SC cbx_stratix 2024:05:14:17:53:42:SC cbx_stratixii 2024:05:14:17:53:42:SC  VERSION_END

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  dual_fifo_cmpr
	( 
	aeb,
	dataa,
...
endmodule //dual_fifo_cmpr

//synthesis_resources = M9K 1 reg 100 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF;REMOVE_DUPLICATE_REGISTERS=OFF;SYNCHRONIZER_IDENTIFICATION=OFF;SYNCHRONIZATION_REGISTER_CHAIN_LENGTH = 2;suppress_da_rule_internal=d101;suppress_da_rule_internal=d102;suppress_da_rule_internal=d103;suppress_da_rule_internal=R105;-name CUT ON -from rdptr_g -to ws_dgrp|dual_fifo_dffpipe12:dffpipe17|dffe18a;-name SDC_STATEMENT \"set_false_path -from *rdptr_g* -to *ws_dgrp|dual_fifo_dffpipe12:dffpipe17|dffe18a* \";-name CUT ON -from delayed_wrptr_g -to rs_dgwp|dual_fifo_dffpipe:dffpipe12|dffe13a;-name SDC_STATEMENT \"set_false_path -from *delayed_wrptr_g* -to *rs_dgwp|dual_fifo_dffpipe:dffpipe12|dffe13a* \""} *)
module  dual_fifo_dcfifo
	( 
	aclr,
	data,
	q,
...
`endif
	...
	dual_fifo_a_graycounter   rdptr_g1p
	( 
	.aclr(aclr),
	.clock(rdclk),
	.cnt_en(valid_rdreq),
	.q(wire_rdptr_g1p_q));
	dual_fifo_a_graycounter1   wrptr_g1p
	( 
	.aclr((~ wire_wraclr_q)),
	.clock(wrclk),
	.cnt_en(valid_wrreq),
	.q(wire_wrptr_g1p_q));
	dual_fifo_altsyncram   fifo_ram
	( 
	.aclr1(aclr),
	...
	dual_fifo_alt_synch_pipe   rs_dgwp
	( 
	.clock(rdclk),
	.clrn((~ aclr)),
	.d(delayed_wrptr_g),
	.q(wire_rs_dgwp_q));
	dual_fifo_dffpipe1   wraclr
	( 
	.clock(wrclk),
	.clrn((~ aclr)),
	.d(1'b1),
	.q(wire_wraclr_q));
	dual_fifo_alt_synch_pipe1   ws_dgrp
	( 
	.clock(wrclk),
	.clrn(wire_wraclr_q),
	.d(rdptr_g),
	.q(wire_ws_dgrp_q));
	dual_fifo_cmpr   rdempty_eq_comp
	( 
	.aeb(wire_rdempty_eq_comp_aeb),
	.dataa(wire_rs_dgwp_q),
	.datab(rdptr_g));
	dual_fifo_cmpr   wrfull_eq_comp
	( 
...
`endif
	...
	dual_fifo_dcfifo	dual_fifo_dcfifo_component (
				.aclr (aclr),
				.data (data),
				.rdclk (rdclk),
				.rdreq (rdreq),
